...
//   // Initialize categoryData to empty array
//   let categoryData: any = [];

//   // If searchTerm is present, filter products based on search
...
//   } else {
//     // If categoryTitle is passed, filter by category (e.g., shirts, jeans, etc.)
//     const newCategoryTitle = categoryTitle.toLowerCase();
